...
//            [DefaultValue(5000)]
    ...
    public bool IsIncluded(ListViewItem lvi) {
      ...
      included &= IsIncluded(m_currentsettings.Filters.TextDataFilterCondition, m_currentsettings.Filters.TextData,
        lvi.SubItems[1].Text);
      included &= IsIncluded(m_currentsettings.Filters.LoginNameFilterCondition, m_currentsettings.Filters.LoginName,
        lvi.SubItems[2].Text);
      ...
      included &= IsIncluded(m_currentsettings.Filters.WritesFilterCondition, m_currentsettings.Filters.Writes,
        lvi.SubItems[5].Text);
      included &= IsIncluded(m_currentsettings.Filters.DurationFilterCondition, m_currentsettings.Filters.Duration,
        lvi.SubItems[6].Text);
